    ...
    return (
        <>
            ...
            <div style={{ display: 'flex' }}>
                <ClickBarPlot dataUrl={dataUrl} selectedList={selectedList} setSelectedList={setSelectedList}></ClickBarPlot>
                <BrushBarPlot dataUrl={dataUrl} selectedList={selectedList} setSelectedList={setSelectedList}></BrushBarPlot>
            </div>
            <p>selected List</p>
            <ul>
